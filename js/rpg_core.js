...
Graphics._formatEventCommandInfo = function(error) {
    ...
    case "plugin_command":
        return "â—†Plugin Command: " + error.content;
    case "script":
        return "â—†Script: " + error.content;
    case "control_variables":
        return "â—†Control Variables: Script: " + error.content;
    case "conditional_branch_script":
        return "â—†If: Script: " + error.content;
    case "set_route_script":
        return "â—†Set Movement Route: â—‡Script: " + error.content;
    case "auto_route_script":
        return "Autonomous Movement Custom Route: â—‡Script: " + error.content;
    case "other":
    default:
        return "";
    }
